...
public class SpigotNMS_1_19_1_R1 extends SpigotNMS_1_19_Common {
	...
	public void hookChatPreview(Plugin plugin, Player player) {
		...
		if (playerChannel.pipeline().get("CommandAPI_" + player.getName()) == null) {
			playerChannel.pipeline().addBefore("packet_handler", "CommandAPI_" + player.getName(), new SpigotNMS_1_19_1_R1_ChatPreviewHandler(this, plugin, player));
		}
	}
