...
public abstract class MockPlatform<CLW> extends CommandAPIBukkit<CLW> {
	...
	static MockBukkitPlatform bukkitPlatform = null;
	...
	public static MockBukkitPlatform getBukkitPlatform() {
		if (MockPlatform.bukkitPlatform == null) {
			throw new IllegalStateException("MockBukkitPlatform not initialized");
		}
		return MockPlatform.bukkitPlatform;
	}
