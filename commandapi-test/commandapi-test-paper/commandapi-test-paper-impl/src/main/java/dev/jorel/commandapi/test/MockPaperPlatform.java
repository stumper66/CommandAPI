...
public abstract class MockPaperPlatform<CLW> extends CommandAPIPaper<CLW> implements MockBukkitPlatform {
	...
	private static MockPaperPlatform<?> paperInstance = null;
	...
	@SuppressWarnings("unchecked")
	public static <CLW> MockPaperPlatform<CLW> getPaperInstance() {
		return (MockPaperPlatform<CLW>) paperInstance;
	}

	protected MockPaperPlatform() {
		if (MockPaperPlatform.paperInstance == null) {
			MockPaperPlatform.paperInstance = this;
			MockPaperPlatform.mockPlatform = (MockPlatform<?>) bukkitNMS();
	...
	public static void unload() {
		MockPaperPlatform.paperInstance = null;
		MockPaperPlatform.mockPlatform = null;
	}
